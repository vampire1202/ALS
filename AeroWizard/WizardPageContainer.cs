...
namespace AeroWizard
{
    ...
    public class WizardPageContainer : ContainerControl, ISupportInitialize
    {
        ...
        private void backButton_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == MessageBox.Show("确认返回上一步操作？", "提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Question))
                PreviousPage();
        }
        ...
        private void nextButton_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == MessageBox.Show("确认进行下一步操作？", "提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Question))
