...
namespace AeroWizard
{
	...
	public class ThemedImageButton : ButtonBase
	{
		...
		{
            get { return Color.FromArgb(255, 1, 163, 215);}
		...
		protected virtual void PaintButton(Graphics graphics, Rectangle bounds)
		{
            ...
            graphics.Clear(Color.FromArgb(255, 1, 163, 215));
				...
				if (base.ImageList != null && base.ImageList.Images.Count > 0)
				{
					...
					else
					{
						...
						if (forceDisabled)
                            ...
                            ControlPaint.DrawImageDisabled(graphics, base.ImageList.Images[idx], 0, 0, Color.FromArgb(255, 1, 163, 215));
						else
						{
		...
		{
            base.ImageList = new ImageList() { ImageSize = imageSize, ColorDepth = ColorDepth.Depth32Bit, TransparentColor = Color.FromArgb(255, 1, 163, 215) };
		}
