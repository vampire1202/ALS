...
namespace AeroWizard
{
		...
		, ISupportInitialize
	{
		...
		public WizardControl()
		{
            ...
            //this.contentArea.BackColor = Color.FromArgb(241, 241, 241);
            //page标题背景色
            //this.header.BackColor = Color.Silver;          
		...
		private void ConfigureStyles(bool aero = true)
		{
			if (aero)
			{
                ...
                //headerLabel.Font = new System.Drawing.Font("微软雅黑", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                //headerLabel.ForeColor = System.Drawing.Color.Azure; //System.Drawing.Color.FromArgb(((int)(((byte)(19)))), ((int)(((byte)(112)))), ((int)(((byte)(171)))));
			...
			else
			{
                ...
                //headerLabel.Font = new System.Drawing.Font("微软雅黑",12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                //headerLabel.ForeColor = System.Drawing.Color.Azure; //SystemColors.ControlText;
		...
		private void SetLayout()
		{
			if (isMin6 && Application.RenderWithVisualStyles)
			{
				...
				using (Graphics g = this.CreateGraphics())
				{
                    ...
                    titleBar.Height = 32; //Math.Max(theme.GetMargins2(g, MarginProperty.ContentMargins).Top, bbSize.Height + 2);
					titleBar.ColumnStyles[0].Width = bbSize.Width+4f;
                    titleBar.ColumnStyles[1].Width = 1;// titleImageIcon != null ? titleImageList.ImageSize.Width : 0;
