...
namespace ALS.DAL
{
    ...
    public partial class warncode
    {
        ...
        public bool Add(ALS.Model.warncode model)
        {
            ...
            strSql.Append("code,content,reason,deal,grade,dealSteps,dealImg)");
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("@dealSteps", MySqlDbType.Text),
					new MySqlParameter("@dealImg", MySqlDbType.Blob)};
            parameters[0].Value = model.code;
            parameters[1].Value = model.content;
            parameters[2].Value = model.reason;
            parameters[3].Value = model.deal;
            parameters[4].Value = model.grade;
            parameters[5].Value = model.dealSteps;
            parameters[6].Value = model.dealImg;
        ...
        public bool Update(ALS.Model.warncode model)
        {
            ...
            strSql.Append("dealSteps=@dealSteps,");
            strSql.Append("dealImg=@dealImg");
            strSql.Append(" where ID=@ID");
            MySqlParameter[] parameters = {
					new MySqlParameter("@code", MySqlDbType.VarChar,255),
					new MySqlParameter("@content", MySqlDbType.VarChar,255),
        ...
        public ALS.Model.warncode GetModel(long ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,code,content,reason,deal,grade,dealSteps,dealImg from tb_warncode ");
            strSql.Append(" where ID=@ID ");
            MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32,20)			};
            parameters[0].Value = ID;
        ...
        public ALS.Model.warncode DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["dealSteps"] != null)
                {
                    model.dealSteps = row["dealSteps"].ToString();
                }
                if (row["dealImg"] != null && row["dealImg"].ToString() != "")
                {
                    model.dealImg = (byte[])row["dealImg"];
                }
            }
            return model;
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,concat(code,':',content) as codecontent,reason,deal,grade,dealSteps,dealImg ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,code,content,reason,deal,grade,dealSteps,dealImg  ");
            strSql.Append(" FROM tb_warncode ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
