...
namespace ALS.DAL
{
    ...
    public partial class warnlog
    {
        ...
        public bool Add(ALS.Model.warnlog model)
        {
            ...
            strSql.Append("ID,logtime,warncode,warntitle,sign,para1,para2,para3)");
            ...
            parameters[2].Value = model.warncode;
            parameters[3].Value = model.warntitle;
            parameters[4].Value = model.sign;
            parameters[5].Value = model.para1;
            parameters[6].Value = model.para2;
            parameters[7].Value = model.para3;
        ...
        public bool Update(ALS.Model.warnlog model)
        {
            ...
            parameters[1].Value = model.warncode;
            parameters[2].Value = model.warntitle;
            parameters[3].Value = model.sign;
            parameters[4].Value = model.para1;
            parameters[5].Value = model.para2;
            parameters[6].Value = model.para3;
        ...
        public ALS.Model.warnlog GetModel(long ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,logtime,warncode,warntitle,sign,para1,para2,para3 from tb_warnlog ");
            strSql.Append(" where ID=@ID ");
            MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32,20)			};
            parameters[0].Value = ID;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,logtime,warncode,warntitle,sign,para1,para2,para3 ");
