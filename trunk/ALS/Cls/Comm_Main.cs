...
namespace ALS.Cls
{
    class Comm_Main
    {
        ...
        public static class CmdAlarmLamp
        {
            ...
            public static byte[] RedClose = new byte[] { 0xFE, 0xA2, 0x00, 0x5C, 0xED };
            public static byte[] GreenTwinkle = new byte[] { 0xFE,0xA3, 0x00, 0x5D, 0xED }; 
            public static byte[] GreenClose = new byte[] { 0xFE ,0xA4 ,0x00 ,0x5A ,0xED }; 
            public static byte[] GreenAlways = new byte[] { 0xFE ,0xA5 ,0x00 ,0x5B ,0xED};
            public static byte[] YellowTwinkle = new byte[] { 0xFE ,0xA6 ,0x00 ,0x58 ,0xED };
            public static byte[] YellowClose = new byte[] { 0xFE ,0xA7 ,0x00 ,0x59 ,0xED};
            public static byte[] AllLightClose = new byte[] { 0xFE ,0xA8 ,0x00 ,0x56 ,0xED};
        ...
        public static class CmdTemperature
        {
            ...
            public static byte[] StartHT(byte target)
            {
