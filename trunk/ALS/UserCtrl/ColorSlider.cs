...
namespace ALS.UserCtrl
{
    public partial class ColorSlider : Control
    {
        ...
        private Color value_1innerColor = Color.Red;
        ...
        private Color value_1PenColor = Color.Silver;
        [Description("Set Slider value_1 pen color")]
        [Category("ColorSlider")]
        [DefaultValue(typeof(Color), "Silver")]
        public Color Value_1PenColor
        {
            get { return value_1PenColor; }
            set
            {
                value_1PenColor = value;
                Invalidate();
            }
        }
        ...
        private Color value_2PenColor = Color.Silver;
        [Description("Set Slider value_2 pen color")]
        [Category("ColorSlider")]
        [DefaultValue(typeof(Color), "Silver")]
        public Color Value_2PenColor
        {
            get { return value_2PenColor; }
            set
            {
                value_2PenColor = value;
                Invalidate();
            }
        }
        //----------------------
        ...
        private Color value_3innerColor = Color.Red;
        ...
        private Color value_3PenColor = Color.Silver;
        [Description("Set Slider value_3 pen color")]
        [Category("ColorSlider")]
        [DefaultValue(typeof(Color), "Silver")]
        public Color Value_3PenColor
        {
            get { return value_3PenColor; }
            set
            {
                value_3PenColor = value;
                Invalidate();
            }
        }
        ...
        {
            base.OnPaint(pe);
            DrawColorSlider(pe, value_1OuterColor, value_1innerColor, value_1PenColor,
                value_2OuterColor, value_2innerColor, value_2PenColor,
                value_3OuterColor, value_3innerColor, value_3PenColor,
                value_Color
                );
        }
        ...
        /// </summary>
        private void DrawColorSlider(PaintEventArgs e, Color _value_1OuterColor, Color _value_1innerColor, Color _value_1PenColor,
                Color _value_2OuterColor, Color _value_2innerColor, Color _value_2PenColor,
                Color _value_3OuterColor, Color _value_3innerColor, Color _value_3PenColor,
                Color _value_Color
            )
        {
            try
            {
                ...
                rectValue_1 = new Rectangle(0, 0, TrackX1, ClientRectangle.Height);
                rectValue_2 = new Rectangle(TrackX1, 0, TrackX2, ClientRectangle.Height);
                rectValue_3 = new Rectangle(TrackX2, 0, ClientRectangle.Width - TrackX2, ClientRectangle.Height);
                ...
                if (Value >= barMinimum & Value < barMaximum)
                {
                    ...
                    Point p1 = new Point(valuep, rectValue_1half.Height);
