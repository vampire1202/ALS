...
namespace ThermometerLib
{
    public partial class ThermometerControl : UserControl
    {
        ...
        [CategoryAttribute("刻度"), Description("刻度数字的颜色")]
        ...
        [CategoryAttribute("背景"), Description("刻度盘最外圈线条的颜色")]
        ...
        [CategoryAttribute("背景"), Description("刻度盘背景颜色")]
        ...
        [CategoryAttribute("刻度"), Description("大刻度线颜色")]
        ...
        [CategoryAttribute("刻度"), Description("小刻度线颜色")]
        ...
        [CategoryAttribute("刻度"), Description("温度柱背景颜色")]
        ...
        [CategoryAttribute("刻度"), Description("温度柱颜色")]
        ...
        {
            // 温度值是否在温度表最大值和最小值范围内
            if (temperature > highTemperature || temperature < lowTemperature)
            {
